...
;
	($.$our_app_dev) = class $our_app_dev extends ($.$mol_book2_catalog) {
		menu_title(){
			return "Разработчик*";
		}
		param(){
		...
		Profile_form(){
			...
			(obj.buttons) = () => ([(this.Update_profile())]);
			return obj;
		}
		Profile_page(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Профиль");
			(obj.body) = () => ([(this.Profile_form())]);
			return obj;
		}
		Game_1(){
			const obj = new this.$.$mol_text();
		...
		Game_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Game_1()), (this.Game_2())]);
			return obj;
		}
		Game_name_control(){
			const obj = new this.$.$mol_string();
		...
		Game_form(){
			...
			(obj.buttons) = () => ([(this.Game_add()), (this.Game_show())]);
			return obj;
		}
		Games(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Игры");
			(obj.body) = () => ([(this.Game_list()), (this.Game_form())]);
			return obj;
		}
		Show_text(){
			const obj = new this.$.$mol_text();
		...
		Show(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Шоу");
			(obj.body) = () => ([(this.Show_text()), (this.Update_show())]);
			return obj;
		}
	};
	($mol_mem(($.$our_app_dev.prototype), "Name_control"));
	($mol_mem(($.$our_app_dev.prototype), "Country_control"));
	($mol_mem(($.$our_app_dev.prototype), "Telegram_control"));
	($mol_mem(($.$our_app_dev.prototype), "Update_profile"));
	($mol_mem(($.$our_app_dev.prototype), "Profile_form"));
	($mol_mem(($.$our_app_dev.prototype), "Profile_page"));
	($mol_mem(($.$our_app_dev.prototype), "Game_1"));
	($mol_mem(($.$our_app_dev.prototype), "Game_2"));
	($mol_mem(($.$our_app_dev.prototype), "Game_list"));
	($mol_mem(($.$our_app_dev.prototype), "Game_name_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_genre_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_description_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_social_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_youtube_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_steam_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_vk_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_date_control"));
	($mol_mem(($.$our_app_dev.prototype), "Game_add"));
	($mol_mem(($.$our_app_dev.prototype), "Game_show"));
	($mol_mem(($.$our_app_dev.prototype), "Game_form"));
	($mol_mem(($.$our_app_dev.prototype), "Games"));
	($mol_mem(($.$our_app_dev.prototype), "Show_text"));
	($mol_mem(($.$our_app_dev.prototype), "Update_show"));
	($mol_mem(($.$our_app_dev.prototype), "Show"));
...
;
	($.$our_app_org) = class $our_app_org extends ($.$mol_book2_catalog) {
		menu_title(){
			return "Организаторы**";
		}
		spreads(){
		...
		Show(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Шоу");
			(obj.body) = () => ([(this.Show_text()), (this.Show_add())]);
			return obj;
		}
		Game_1(){
			const obj = new this.$.$mol_text();
		...
		Feedback_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Feedback_game())]);
			return obj;
		}
		Feedback(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Обратная связь");
			(obj.body) = () => ([(this.Feedback_text()), (this.Feedback_list())]);
			return obj;
		}
		Request_text(){
			const obj = new this.$.$mol_text();
		...
		Request(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Заявки");
			(obj.body) = () => ([(this.Request_text())]);
			return obj;
		}
	};
	($mol_mem(($.$our_app_org.prototype), "Show_text"));
	($mol_mem(($.$our_app_org.prototype), "Show_add"));
	($mol_mem(($.$our_app_org.prototype), "Show"));
	($mol_mem(($.$our_app_org.prototype), "Game_1"));
	($mol_mem(($.$our_app_org.prototype), "Game_feedback"));
	($mol_mem(($.$our_app_org.prototype), "Game_feedback_add"));
	($mol_mem(($.$our_app_org.prototype), "Games_list"));
	($mol_mem(($.$our_app_org.prototype), "Games"));
	($mol_mem(($.$our_app_org.prototype), "Feedback_text"));
	($mol_mem(($.$our_app_org.prototype), "Feedback_game"));
	($mol_mem(($.$our_app_org.prototype), "Feedback_list"));
	($mol_mem(($.$our_app_org.prototype), "Feedback"));
	($mol_mem(($.$our_app_org.prototype), "Request_text"));
	($mol_mem(($.$our_app_org.prototype), "Request"));
...
;
	($.$our_app) = class $our_app extends ($.$mol_book2_catalog) {
		menu_title(){
			return "Нашы Игры";
		}
		param(){
	...
	($mol_mem(($.$our_app.prototype), "GitHub"));
	($mol_mem(($.$our_app.prototype), "Telegram_icon"));
	($mol_mem(($.$our_app.prototype), "Telegram"));
	($mol_mem(($.$our_app.prototype), "Show_text"));
	($mol_mem(($.$our_app.prototype), "Show"));
	($mol_mem(($.$our_app.prototype), "Game_text"));
	($mol_mem(($.$our_app.prototype), "Games"));
	($mol_mem(($.$our_app.prototype), "Dev"));
	($mol_mem(($.$our_app.prototype), "Org"));
	($mol_mem(($.$our_app.prototype), "About_text"));
	($mol_mem(($.$our_app.prototype), "About"));
